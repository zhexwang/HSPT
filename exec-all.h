...
#define CF_LAST_IO     0x8000 /* Last insn may be an IO access.  */
    ...
    uint32_t icount;
	// This flag represents that this tb has been translated using SPT opt, but SMC happen to the phys page of this TB.
	// when SMC happens, this tb should retranslated without SPT.
    bool spt_disabled;
	uint32_t smc_count;
};
